...
- Three jupyter notebook files containing:
    ...
    - the application of different non-LLM classification algorithms and the application of different methods in order to create a vector representation of texts;
...
- Tre file jupyter notebook che contengono:
  ...
  - l'applicazione di divesi algoritmi di classificazione (non LLM) e l'applicazione di diversi metodi al fine di creare una rappresentazione vettoriale dei testi;
